    ...
    <div class="container">
        <div class="row">
            <div class="col-12 d-flex flex-column align-items-center">
                <?php
                    $feature_suptitle = get_field('feature_suptitle');
                    ...
                    <?php endif;
                        $feature_descr = get_field('feature_description');
